audiomanagementsystem: noiseGate.o echo.o normalization.o menu.o wav.o main.cpp
	g++ -std=c++11 -o audiomanagementsystem noiseGate.o echo.o normalization.o menu.o wav.o main.cpp
